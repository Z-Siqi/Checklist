 ...
 *
 * @throws ClassCastException if the detail type is not [TaskInfo.DetailInfoState.DetailType.Text].
 */
@Composable
internal fun TextDetailDialog(
    ...
    val textType = detail.detailType as TaskInfo.DetailInfoState.DetailType.Text
    ...
    InfoDialogScaffold(
        ...
        InfoDetailDialogTitle(
            detailTitle = stringResource(R.string.text),
        ...
        SelectionContainer {
            ...
            TextTypeCard(text = textType.description)
        }
...
@Composable
private fun TextTypeCard(text: String) {
...
@Preview
@Composable
private fun TextDetailDialogPreview() {
    TextDetailDialog(
        detail = TaskInfo.DetailInfoState(
