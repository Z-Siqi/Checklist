        ...
        Surface(
            ...
            if (deleteAllView) {
                WarningAlertDialog(
                    ...
                    text = { Text("Delete All History Task?") }
                )
            }
            if (redoAllView) {
                WarningAlertDialog(
                    ...
                    text = { Text("Redo All History Task?") }
                )
            }
        }
    }
...
private fun HistoryNavBar(
    ...
    NavigationBar(
        ...
        NavigationBarItem(
            colors = colors,
            icon = { Icon(imageVector = Icons.Filled.Refresh, contentDescription = "Redo") },
            label = { Text(text = "Redo") },
            selected = taskState.onSelect,
            onClick = {
                if (taskState.onSelect) {
                ...
                Box(modifier = padding) {
                    Column {
                        ...
                        Row(verticalAlignment = Alignment.Bottom) {
                            Text(
                                text = "Task creation time: ${createDate.format(formatter)}",
