package sqz.checklist.task.api.modify
...
interface TaskModify {
     ...
     *
     * @return a [kotlinx.coroutines.flow.StateFlow] emitting the current state of the task modify.
     */
    ...
    interface Detail {
         ...
         * match the [sqz.checklist.data.database.TaskDetailType].
         *
